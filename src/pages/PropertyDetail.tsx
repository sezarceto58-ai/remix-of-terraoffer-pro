  ...
  if (!property) {
    return (
      <div className="text-center py-20">
        ...
        <Link to="/" className="text-primary text-sm mt-2 inline-block">Back to marketplace</Link>
      </div>
    );
  }
      ...
      <div className="rounded-xl overflow-hidden mb-6">
        <div className="relative aspect-[16/9] lg:aspect-[2/1]">
          ...
          <div className="absolute top-4 right-4 flex gap-2">
            <button className="p-2.5 rounded-lg bg-background/40 backdrop-blur-sm text-foreground hover:text-primary transition-colors">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div>
            ...
            <div className="flex items-center gap-6 mt-4 text-sm text-muted-foreground">
              {property.bedrooms > 0 && (
                <span className="flex items-center gap-1.5"><Bed className="w-4 h-4" /> {property.bedrooms} Beds</span>
              )}
          ...
          <div className="rounded-xl bg-card border border-border p-5">
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              {property.features.map((f) => (
                <span key={f} className="px-3 py-1 rounded-full bg-secondary text-secondary-foreground text-xs">
                  {f}
                </span>
              ))}
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl bg-card border border-border p-5 shadow-card sticky top-20">
            ...
            <div className="mt-5 space-y-3">
              ...
              <button className="w-full py-3 rounded-xl bg-secondary text-secondary-foreground font-medium text-sm hover:bg-secondary/80 transition-colors flex items-center justify-center gap-2">
